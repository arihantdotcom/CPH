...
\path[draw=softred,thick,->,line width=2pt] (o) -- (m);
\path[draw=softred,thick,->,line width=2pt] (o) -- (n);

\path[draw=softred,thick,->,line width=2pt] (m) -- (j);
\path[draw=softred,thick,->,line width=2pt] (j) -- (c);
\path[draw=softred,thick,->,line width=2pt] (j) -- (d);
\path[draw=softred,thick,->,line width=2pt] (c) -- (5.5,1);

\path[draw=softred,thick,->,line width=2pt] (n) -- (k);
\path[draw=softred,thick,->,line width=2pt] (n) -- (l);

\path[draw=softred,thick,->,line width=2pt] (l) -- (g);
...
\path[draw=softred,thick,->,line width=2pt] (k) -- (f);
\path[draw=softred,thick,->,line width=2pt] (l) -- (g);

\draw [decoration={brace}, decorate, line width=0.5mm] (14,-0.25) -- (10,-0.25);

\draw[color=softblue,thick] (8,1.5) rectangle (12,5.5);
...
\node[draw, circle,minimum size=13pt,fill=softred] (1b) at (3+5,0) {};
\node[draw, circle,minimum size=13pt,fill=softred] (2b) at (2+5,-1) {};
\node[draw, circle,minimum size=13pt] (3b) at (4+5,-1) {};
\node[draw, circle,minimum size=13pt] (4b) at (1.5+5,-2) {};
\node[draw, circle,minimum size=13pt,fill=softred] (5b) at (2.5+5,-2) {};
...
\node[draw, circle,minimum size=13pt,fill=softred] (1c) at (3+10,0) {};
\node[draw, circle,minimum size=13pt] (2c) at (2+10,-1) {};
\node[draw, circle,minimum size=13pt,fill=softred] (3c) at (4+10,-1) {};
...
\node[draw, circle,minimum size=13pt,fill=softred] (7c) at (4.5+10,-2) {};
