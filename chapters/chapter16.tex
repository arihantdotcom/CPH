...
\node[color=softred] at (1,2.3) {$1$};
\node[color=softred] at (3,2.3) {$1$};
\node[color=softred] at (5,2.3) {$3$};
\node[color=softred] at (1,5.7) {$1$};
\node[color=softred] at (3,5.7) {$2$};
\node[color=softred] at (5,5.7) {$3$};
\end{tikzpicture}
\end{center}
...
\node[color=softred] at (0,0.7) {$1$};
\node[color=softred] at (2,0.7) {$1$};
\node[color=softred] at (0,-2.7) {$2$};
\node[color=softred] at (2,-2.7) {$3$};
\node[color=softred] at (4,-1.7) {$3$};
\end{tikzpicture}
\end{center}
