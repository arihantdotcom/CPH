...
\begin{center}
\begin{tikzpicture}[scale=0.9]
\node[draw, circle, fill=softblue!40] (1) at (1,3) {$2$};
\node[draw, circle, fill=softred!40] (2) at (4,3) {$3$};
\node[draw, circle, fill=softred!40] (3) at (1,1) {$5$};
\node[draw, circle, fill=softblue!40] (4) at (4,1) {$6$};
\node[draw, circle, fill=softred!40] (5) at (-2,1) {$4$};
\node[draw, circle, fill=softblue!40] (6) at (-2,3) {$1$};
\path[draw,thick,-] (1) -- (2);
\path[draw,thick,-] (1) -- (3);
\path[draw,thick,-] (3) -- (4);
\path[draw,thick,-] (2) -- (4);
...
\path[draw=softred,thick,-,line width=2pt] (6) -- (1);
\end{tikzpicture}
\end{center}
