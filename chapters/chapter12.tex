...
\path[draw=softred,thick,->,line width=2pt] (1) -- (2);
\path[draw=softred,thick,->,line width=2pt] (2) -- (3);
\path[draw=softred,thick,->,line width=2pt] (3) -- (5);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) -- (3);
\path[draw=softred,thick,->,line width=2pt] (3) -- (2);
\path[draw=softred,thick,->,line width=2pt] (2) -- (5);
...
\begin{center}
\begin{tikzpicture}
\node[draw, circle,fill=softred!40] (2) at (5,5) {$2$};
\node[draw, circle,fill=softblue!40] (1) at (3,5) {$1$};
\node[draw, circle,fill=softblue!40] (3) at (7,4) {$3$};
\node[draw, circle,fill=softred!40] (5) at (5,3) {$5$};
\node[draw, circle] (4) at (3,3) {$4$};
