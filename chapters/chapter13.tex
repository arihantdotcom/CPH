...
\node[color=softred] at (1,3+0.55) {$0$};
\node[color=softred] at (4,3+0.55) {$\infty$};
\node[color=softred] at (1,1-0.55) {$\infty$};
\node[color=softred] at (4,1-0.55) {$\infty$};
\node[color=softred] at (6,2-0.55) {$\infty$};
...
\node[color=softred] at (1,3+0.55) {$0$};
\node[color=softred] at (4,3+0.55) {$5$};
\node[color=softred] at (1,1-0.55) {$3$};
\node[color=softred] at (4,1-0.55) {$7$};
\node[color=softred] at (6,2-0.55) {$\infty$};
\path[draw,thick,-] (1) -- node[font=\small,label=above:5] {} (2);
\path[draw,thick,-] (1) -- node[font=\small,label=left:3] {} (3);
\path[draw,thick,-] (3) -- node[font=\small,label=below:1] {} (4);
...
\path[draw=softred,thick,->,line width=2pt] (1) -- (2);
\path[draw=softred,thick,->,line width=2pt] (1) -- (3);
\path[draw=softred,thick,->,line width=2pt] (1) -- (4);
\end{tikzpicture}
\end{center}
After this, edges
...
\node[color=softred] at (4,3+0.55) {$5$};
\node[color=softred] at (1,1-0.55) {$3$};
\node[color=softred] at (4,1-0.55) {$4$};
\node[color=softred] at (6,2-0.55) {$7$};
\path[draw,thick,-] (1) -- node[font=\small,label=above:5] {} (2);
\path[draw,thick,-] (1) -- node[font=\small,label=left:3] {} (3);
\path[draw,thick,-] (3) -- node[font=\small,label=below:1] {} (4);
\path[draw,thick,-] (2) -- node[font=\small,label=left:3] {} (4);
...
\path[draw=softred,thick,->,line width=2pt] (2) -- (5);
...
\node[color=softred] at (1,1-0.55) {$3$};
\node[color=softred] at (4,1-0.55) {$4$};
\node[color=softred] at (6,2-0.55) {$6$};
\path[draw,thick,-] (1) -- node[font=\small,label=above:5] {} (2);
\path[draw,thick,-] (1) -- node[font=\small,label=left:3] {} (3);
\path[draw,thick,-] (3) -- node[font=\small,label=below:1] {} (4);
\path[draw,thick,-] (2) -- node[font=\small,label=left:3] {} (4);
...
\path[draw=softred,thick,->,line width=2pt] (4) -- (5);
\end{tikzpicture}
\end{center}
...
\node[color=softred] at (1,3+0.6) {$\infty$};
\node[color=softred] at (4,3+0.6) {$\infty$};
\node[color=softred] at (1,1-0.6) {$\infty$};
\node[color=softred] at (4,1-0.6) {$0$};
\node[color=softred] at (6,2-0.6) {$\infty$};
...
\node[color=softred] at (1,3+0.6) {$\infty$};
\node[color=softred] at (4,3+0.6) {$9$};
\node[color=softred] at (1,1-0.6) {$5$};
\node[color=softred] at (4,1-0.6) {$0$};
\node[color=softred] at (6,2-0.6) {$1$};
...
\path[draw=softred,thick,->,line width=2pt] (4) -- (2);
\path[draw=softred,thick,->,line width=2pt] (4) -- (3);
\path[draw=softred,thick,->,line width=2pt] (4) -- (5);
\end{tikzpicture}
\end{center}
In this case,
...
\node[color=softred] at (1,3+0.6) {$\infty$};
\node[color=softred] at (4,3+0.6) {$3$};
\node[color=softred] at (1,1-0.6) {$5$};
\node[color=softred] at (4,1-0.6) {$0$};
\node[color=softred] at (6,2-0.6) {$1$};
...
\path[draw=softred,thick,->,line width=2pt] (5) -- (2);
\end{tikzpicture}
\end{center}
...
\node[color=softred] at (1,3+0.6) {$9$};
\node[color=softred] at (4,3+0.6) {$3$};
\node[color=softred] at (1,1-0.6) {$5$};
\node[color=softred] at (4,1-0.6) {$0$};
\node[color=softred] at (6,2-0.6) {$1$};
...
\path[draw=softred,thick,->,line width=2pt] (2) -- (1);
\end{tikzpicture}
\end{center}
...
\node[color=softred] at (1,3+0.6) {$7$};
\node[color=softred] at (4,3+0.6) {$3$};
\node[color=softred] at (1,1-0.6) {$5$};
\node[color=softred] at (4,1-0.6) {$0$};
\node[color=softred] at (6,2-0.6) {$1$};
