...
\begin{tikzpicture}[scale=.65]
  \begin{scope}
    ...
    \path[draw=softred,thick,-,line width=2pt] (6.5,-5.5) -- (5.5,-4.5);
    \path[draw=softred,thick,-,line width=2pt] (5.5,-4.5) -- (4.5,-4.5);
    \path[draw=softred,thick,->,line width=2pt] (4.5,-4.5) -- (1.5,-1.5);
  \end{scope}
\end{tikzpicture}
\end{center}
