...
\node[color=softblue] at (0,-0.75) {\texttt{A}};
\node[color=softblue] at (2,-0.75) {\texttt{B}};
\node[color=softblue] at (4,-0.75) {\texttt{C}};
\node[color=softblue] at (6,-0.75) {\texttt{D}};
...
\node[color=softblue] at (0,-0.75) {\texttt{A}};
\node[color=softblue] at (2,-0.75) {\texttt{C}};
\node[color=softblue] at (4,-0.75) {\texttt{B}};
\node[color=softblue] at (6,-0.75) {\texttt{D}};
...
\node[color=softblue] at (1,-0.75) {\texttt{A}};
\node[color=softblue] at (3,1-0.75) {\texttt{C}};
\node[color=softblue] at (4,-0.75) {\texttt{B}};
\node[color=softblue] at (6,-0.75) {\texttt{D}};
...
\node[color=softblue] at (2,2-0.75) {\texttt{A}};
\node[color=softblue] at (3,1-0.75) {\texttt{C}};
\node[color=softblue] at (4,-0.75) {\texttt{B}};
\node[color=softblue] at (6,-0.75) {\texttt{D}};
