...
\draw[fill=softblue] (0.5,0.2) circle (0.1);
\draw[fill=softred] (1.7,0.2) circle (0.1);
\draw[fill=softred] (3.5,0.2) circle (0.1);
\draw[fill=softblue] (4.7,0.2) circle (0.1);
\draw[fill=softblue] (6.25,0.2) circle (0.1);
\draw[fill=softred] (6.75,0.2) circle (0.1);
\draw[fill=softblue] (10.45,0.2) circle (0.1);
\draw[fill=softred] (10.95,0.2) circle (0.1);
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[scale=0.9]
\node[draw, circle, fill=softblue!40] (1) at (1,3) {$1$};
\node[draw, circle, fill=softred!40] (2) at (4,3) {$2$};
\node[draw, circle, fill=softred!40] (3) at (1,1) {$3$};
\node[draw, circle, fill=softblue!40] (4) at (4,1) {$4$};
\node[draw, circle, fill=softblue!40] (5) at (6,2) {$5$};
