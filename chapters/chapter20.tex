...
\path[draw=softred,thick,-,line width=2pt] (4-.3,3-.3) -- (4+.3,3+.3);
\path[draw=softred,thick,-,line width=2pt] (4-.3,3+.3) -- (4+.3,3-.3);
\path[draw=softred,thick,-,line width=2pt] (4-.3,1-.3) -- (4+.3,1+.3);
\path[draw=softred,thick,-,line width=2pt] (4-.3,1+.3) -- (4+.3,1-.3);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend left=10] (2);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend left=10] (3);
\path[draw=softred,thick,->,line width=2pt] (3) edge [bend left=10] (6);
\path[draw=softred,thick,->,line width=2pt] (6) edge [bend left=10] (4);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend left=10] (5);
\path[draw=softred,thick,->,line width=2pt] (5) edge [bend left=10] (2);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend left=10] (3);
\path[draw=softred,thick,->,line width=2pt] (3) edge [bend left=10] (4);
\end{tikzpicture}
\end{center}
...
\path[draw=softgreen,thick,->,line width=2pt] (1) -- (2);
\path[draw=softgreen,thick,->,line width=2pt] (2) -- (4);
\path[draw=softgreen,thick,->,line width=2pt] (4) -- (3);
\path[draw=softgreen,thick,->,line width=2pt] (3) -- (6);

\path[draw=softblue,thick,->,line width=2pt] (1) -- (4);
\path[draw=softblue,thick,->,line width=2pt] (4) -- (5);
\path[draw=softblue,thick,->,line width=2pt] (5) -- (6);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) -- (2a);
\path[draw=softred,thick,->,line width=2pt] (2a) -- (2b);
\path[draw=softred,thick,->,line width=2pt] (2b) -- (4a);
\path[draw=softred,thick,->,line width=2pt] (4a) -- (4b);
\path[draw=softred,thick,->,line width=2pt] (4b) -- (3a);
\path[draw=softred,thick,->,line width=2pt] (3a) -- (3b);
\path[draw=softred,thick,->,line width=2pt] (3b) -- (6);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,-,line width=2pt] (1) -- (5);
\path[draw=softred,thick,-,line width=2pt] (2) -- (7);
\path[draw=softred,thick,-,line width=2pt] (3) -- (8);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (a) -- (1);
\path[draw=softred,thick,->,line width=2pt] (a) -- (2);
\path[draw=softred,thick,->,line width=2pt] (a) -- (3);

\path[draw=softred,thick,->,line width=2pt] (5) -- (b);
\path[draw=softred,thick,->,line width=2pt] (7) -- (b);
\path[draw=softred,thick,->,line width=2pt] (8) -- (b);
...
\path[draw=softred,thick,-,line width=2pt] (1) -- (5);
\path[draw=softred,thick,-,line width=2pt] (2) -- (7);
\path[draw=softred,thick,-,line width=2pt] (3) -- (6);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) -- (5);
\path[draw=softred,thick,->,line width=2pt] (5) -- (6);
\path[draw=softred,thick,->,line width=2pt] (6) -- (7);
\path[draw=softred,thick,->,line width=2pt] (3) -- (4);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1a) -- (5b);
\path[draw=softred,thick,->,line width=2pt] (5a) -- (6b);
\path[draw=softred,thick,->,line width=2pt] (6a) -- (7b);
\path[draw=softred,thick,->,line width=2pt] (3a) -- (4b);
...
\path[draw=softred,thick,->,line width=2pt] (1) -- (5);
\path[draw=softred,thick,->,line width=2pt] (5) -- (6);
\path[draw=softred,thick,->,line width=2pt] (6) -- (3);
\path[draw=softred,thick,->,line width=2pt] (3) -- (4);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (2) -- (6);
\path[draw=softred,thick,->,line width=2pt] (6) -- (7);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1a) -- (5b);
\path[draw=softred,thick,->,line width=2pt] (5a) -- (3b);
\path[draw=softred,thick,->,line width=2pt] (3a) -- (4b);
\path[draw=softred,thick,->,line width=2pt] (2a) -- (6b);
\path[draw=softred,thick,->,line width=2pt] (6a) -- (7b);


% \path[draw=softred,thick,->,line width=2pt] (1a) -- (6b);
% \path[draw=softred,thick,->,line width=2pt] (1a) -- (7b);
% \path[draw=softred,thick,->,line width=2pt] (1a) -- (3b);
% \path[draw=softred,thick,->,line width=2pt] (1a) -- (4b);
% \path[draw=softred,thick,->,line width=2pt] (5a) -- (6b);
% \path[draw=softred,thick,->,line width=2pt] (5a) -- (7b);
% \path[draw=softred,thick,->,line width=2pt] (5a) -- (3b);
% \path[draw=softred,thick,->,line width=2pt] (5a) -- (4b);
% \path[draw=softred,thick,->,line width=2pt] (6a) -- (7b);
% \path[draw=softred,thick,->,line width=2pt] (6a) -- (7b);
% \path[draw=softred,thick,->,line width=2pt] (6a) -- (3b);
% \path[draw=softred,thick,->,line width=2pt] (3a) -- (4b);
% \path[draw=softred,thick,->,line width=2pt] (2a) -- (6b);
% \path[draw=softred,thick,->,line width=2pt] (2a) -- (7b);
% \path[draw=softred,thick,->,line width=2pt] (2a) -- (3b);
% \path[draw=softred,thick,->,line width=2pt] (2a) -- (4b);
