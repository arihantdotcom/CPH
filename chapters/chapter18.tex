...
\path[draw=softred,thick,->,line width=2pt] (8) edge [bend left] (3);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend right] (1);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (2);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend right=15] (6);
\path[draw=softred,thick,->,line width=2pt] (6) edge [bend right=15] (2);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend right=15] (1);
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (3);
\path[draw=softred,thick,->,line width=2pt] (3) edge [bend right=15] (1);
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (4);
\path[draw=softred,thick,->,line width=2pt] (4) edge [bend right=15] (7);
\path[draw=softred,thick,->,line width=2pt] (7) edge [bend right=15] (4);
\path[draw=softred,thick,->,line width=2pt] (4) edge [bend right=15] (8);
\path[draw=softred,thick,->,line width=2pt] (8) edge [bend right=15] (4);
\path[draw=softred,thick,->,line width=2pt] (4) edge [bend right=15] (9);
\path[draw=softred,thick,->,line width=2pt] (9) edge [bend right=15] (4);
\path[draw=softred,thick,->,line width=2pt] (4) edge [bend right=15] (1);
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (5);
\path[draw=softred,thick,->,line width=2pt] (5) edge [bend right=15] (1);
...
\node[color=softblue] at (0,3+0.65) {2};
\node[color=softblue] at (-3-0.65,1) {3};
\node[color=softblue] at (-1-0.65,1) {5};
\node[color=softblue] at (1+0.65,1) {3};
\node[color=softblue] at (3+0.65,1) {1};
\node[color=softblue] at (-3,-1-0.65) {4};
\node[color=softblue] at (-0.5,-1-0.65) {4};
\node[color=softblue] at (1,-1-0.65) {3};
\node[color=softblue] at (2.5,-1-0.65) {1};
\end{tikzpicture}
\end{center}
...
\node[color=softblue] at (0,3+0.65) {4};
\node[color=softblue] at (-3-0.65,1) {5};
\node[color=softblue] at (-1-0.65,1) {3};
\node[color=softblue] at (1+0.65,1) {5};
\node[color=softblue] at (3+0.65,1) {2};
\node[color=softblue] at (-3,-1-0.65) {3};
\node[color=softblue] at (-0.5,-1-0.65) {5};
\node[color=softblue] at (1,-1-0.65) {3};
\node[color=softblue] at (2.5,-1-0.65) {1};
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (6) edge [bend left] (3);
\path[draw=softred,thick,->,line width=2pt] (8) edge [bend right=40] (3);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (8) edge [bend right] (7);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (6) edge [bend left] (3);
\path[draw=softred,thick,->,line width=2pt] (7) edge [bend right] (3);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (3);
\path[draw=softred,thick,->,line width=2pt] (3) edge [bend right=15] (6);
\path[draw=softred,thick,->,line width=2pt] (6) edge [bend right=15] (3);
\path[draw=softred,thick,->,line width=2pt] (3) edge [bend right=15] (7);
\path[draw=softred,thick,->,line width=2pt] (7) edge [bend right=15] (8);
\path[draw=softred,thick,->,line width=2pt] (8) edge [bend right=15] (7);
\path[draw=softred,thick,->,line width=2pt] (7) edge [bend right=15] (3);
\path[draw=softred,thick,->,line width=2pt] (3) edge [bend right=15] (1);
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (4);
\path[draw=softred,thick,->,line width=2pt] (4) edge [bend right=15] (1);
\path[draw=softred,thick,->,line width=2pt] (1) edge [bend right=15] (2);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend right=15] (5);
\path[draw=softred,thick,->,line width=2pt] (5) edge [bend right=15] (2);
\path[draw=softred,thick,->,line width=2pt] (2) edge [bend right=15] (1);
\end{tikzpicture}
\end{center}
...
\path[draw=softred,thick,-,line width=2pt] (8) -- node[font=\small] {} (7);
\path[draw=softred,thick,-,line width=2pt] (7) -- node[font=\small] {} (3);
\path[draw=softred,thick,-,line width=2pt] (6) -- node[font=\small] {} (3);
\end{tikzpicture}
\end{center}
...
\draw [softred,thick,dashed,line width=2pt,rotate around={-28:(-2,0)}] (-2.9,1.5) rectangle (-1.9,-2);


\draw [softred,thick,dashed,line width=2pt] (-1.5,-0.5) rectangle (-0.5,-1.5);
\draw [softred,thick,dashed,line width=2pt] (-1.5,-2.5) rectangle (-0.5,-3.5);

\draw [softred,thick,dashed,line width=2pt] (0.5,3.5) rectangle (-0.5,2.5);
\draw [softred,thick,dashed,line width=2pt] (0.5,1.5) rectangle (-0.5,0.5);
\draw [softred,thick,dashed,line width=2pt] (2.5,1.5) rectangle (1.5,0.5);
\draw [softred,thick,dashed,line width=2pt] (2.5,-0.5) rectangle (1.5,-1.5);
\end{tikzpicture}
\end{center}
...
\draw [softred,thick,dashed,line width=2pt] (0.5,3.5) rectangle (-3.5,-3.5);
\draw [softred,thick,dashed,line width=2pt] (2.5,1.5) rectangle (1.5,0.5);
\draw [softred,thick,dashed,line width=2pt] (2.5,-0.5) rectangle (1.5,-1.5);
