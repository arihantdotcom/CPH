...
\path[draw,thick,-,color=softred,line width=2pt] (7) -- (3);
\path[draw,thick,-,color=softred,line width=2pt] (3) -- (1);
\path[draw,thick,-,color=softred,line width=2pt] (1) -- (2);
\path[draw,thick,-,color=softred,line width=2pt] (2) -- (5);
\end{tikzpicture}
\end{center}
...
\path[draw,thick,-] (3) -- (6);
\path[draw,thick,-] (3) -- (7);
\node[color=softred] at (2,1.6) {$a$};
\node[color=softred] at (-2,1.6) {$b$};
\node[color=softred] at (4,1.6) {$c$};
...
\node[color=softred] at (2,-1.6) {$a$};
\node[color=softred] at (-2,1.6) {$b$};
\node[color=softred] at (6,1.6) {$c$};
\node[color=softred] at (2,1.6) {$x$};
...
\path[draw,thick,->,color=softred,line width=2pt] (1) -- (3);
\path[draw,thick,->,color=softred,line width=2pt] (3) -- (6);
\end{tikzpicture}
\end{center}
...
\path[draw,thick,->,color=softred,line width=2pt] (4) -- (1);
\path[draw,thick,->,color=softred,line width=2pt] (1) -- (3);
\path[draw,thick,->,color=softred,line width=2pt] (3) -- (6);
\end{tikzpicture}
\end{center}
